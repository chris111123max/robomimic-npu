...
def main():
 ...
 assert phase_at(4999,c)["actor_updates"] is False and phase_at(5000,c)["actor_lr"]==0 and phase_at(10000,c)["actor_lr"]==.0001 and phase_at(20000,c)["actor_lr"]==c["actor_target_lr"]
