...
def main():
    ...
    env_steps=episode_index=0;context=None;terminated_count=truncated_count=success_count=0;sim_fatal_error_count=consecutive_sim_fatal_errors=0;selector_counts={"rnn":0,"rl":0};selector_window={"rnn":0,"rl":0,"q_rnn":[],"q_rl":[],"margin":[]}
    if a.resume:
